const cacheName = "1786705292801"; // this gets replaced by the build script
...
self.addEventListener("fetch", (e) => {
  ...
  // Cache GET requests over http/https only
  if (e.request.method !== 'GET' || !(url.startsWith('http:') || url.startsWith('https:'))) {
    return;
  }
  e.respondWith(
    (async () => {
